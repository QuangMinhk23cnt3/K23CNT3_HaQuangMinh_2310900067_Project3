...
import K23Cnt3HaQuangMinhPrj3_WebBanThuCung.repository.HqmAdminRepository;
...
public class HqmAdminAuthController {
    @Autowired
    private HqmAdminRepository adminRepo;
    ...
    public String doLogin(@RequestParam String username, @RequestParam String password, HttpSession session, Model model){
        HqmAdmin admin = adminRepo.findByUsername(username).orElse(null);
